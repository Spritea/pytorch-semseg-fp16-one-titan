...
class FPA(nn.Module):
    ...
    def forward(self, x):
        ...
        return out
#MV1_5_1 add post process
class MV1_5_1_ResNet(nn.Module):

    def __init__(self, block, layers, num_classes=1000):
        super(MV1_5_1_ResNet, self).__init__()
        self.inplanes = 64
        ...
        self.post_proc43 = conv3x3_bn(1024*2,1024)
        self.fuse32 = MultiResolutionFuse(1024, 512)
        self.post_proc32 = conv3x3_bn(512*2,512)
        self.fuse21 = MultiResolutionFuse(512, 256)
        self.post_proc21 = conv3x3_bn(256*2,256)
    ...
    def forward(self, x):
        ...
        x_fuse43=self.post_proc43(x_fuse43)
        x_fuse32 = self.fuse32(x_fuse43, l2)
        x_fuse32=self.post_proc32(x_fuse32)
        x_fuse21 = self.fuse21(x_fuse32, l1)
        x_fuse21=self.post_proc21(x_fuse21)
...
def MV1_5_1_ResNet18(num_classes, pretrained=False, **kwargs):
    """Constructs a MV1_ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = MV1_5_1_ResNet(BasicBlock, [2, 2, 2, 2], **kwargs, num_classes=num_classes)
    if pretrained:
        key = '18_imagenet'
        url = models_urls[key]
...
def MV1_5_1_ResNet34(num_classes, pretrained=False, **kwargs):
    """Constructs a MV1_ResNet-34 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = MV1_5_1_ResNet(BasicBlock, [3, 4, 6, 3], **kwargs, num_classes=num_classes)
    if pretrained:
        key = '34_imagenet'
        url = models_urls[key]
        model.load_state_dict(maybe_download(key, url), strict=False)
...
def MV1_5_1_ResNet50(num_classes, pretrained=True, **kwargs):
    """Constructs a MV1_ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = MV1_5_1_ResNet(Bottleneck, [3, 4, 6, 3], **kwargs, num_classes=num_classes)
    if pretrained:
        key = '50_imagenet'
        url = models_urls[key]
        model.load_state_dict(maybe_download(key, url), strict=False)
...
def MV1_5_1_ResNet101(num_classes, pretrained=False, **kwargs):
    """Constructs a MV1_ResNet-101 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = MV1_5_1_ResNet(Bottleneck, [3, 4, 23, 3], **kwargs, num_classes=num_classes)
    if pretrained:
        key = '101_imagenet'
        url = models_urls[key]
        model.load_state_dict(maybe_download(key, url), strict=False)
...
def MV1_5_1_ResNet152(num_classes, pretrained=False, **kwargs):
    """Constructs a MV1_ResNet-152 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = MV1_5_1_ResNet(Bottleneck, [3, 8, 36, 3], **kwargs, num_classes=num_classes)
    if pretrained:
        key = '152_imagenet'
        url = models_urls[key]
        model.load_state_dict(maybe_download(key, url), strict=False)

...
class GCN(nn.Module):
    def __init__(self, num_classes, pretrained=True):
        ...
        if pretrained:
            key = '50_imagenet'
            url = models_urls[key]
            resnet.load_state_dict(maybe_download(key, url), strict=False)
        ...
        self.gcm1 = _GlobalConvModule(2048, num_classes, (15, 15))
        self.gcm2 = _GlobalConvModule(1024, num_classes, (15, 15))
        self.gcm3 = _GlobalConvModule(512, num_classes, (15, 15))
        self.gcm4 = _GlobalConvModule(256, num_classes, (15, 15))
    ...
    def forward(self, x):
        ...
        out = self.brm9(F.upsample_bilinear(fs4, input_size))  # 512

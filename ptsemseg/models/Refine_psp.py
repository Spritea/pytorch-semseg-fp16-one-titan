...
from ptsemseg.models.utils import pyramidPooling
...
def rf101(num_classes, imagenet=False, pretrained=True, **kwargs):
    model = Refine_pspNet(Bottleneck, [3, 4, 23, 3], num_classes=num_classes, **kwargs)
    if imagenet:
        key = '101_imagenet'
        url = models_urls[key]

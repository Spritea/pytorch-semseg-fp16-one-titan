...
class ResNet_Bottleneck_OS16(nn.Module):
    def __init__(self, num_layers):
        ...
        if num_layers == 50:
            ...
            a=torch.load("/home/spl03/.torch/models/50_imagenet.pth.tar")
            # load pretrained model:
            resnet.load_state_dict(torch.load("/home/spl03/.torch/models/50_imagenet.pth.tar"))
            ...
            # load pretrained model:
            resnet.load_state_dict(torch.load("/home/spl03/.torch/models/101_imagenet.pth.tar"))
            # remove fully connected layer, avg pool and layer5:
            self.resnet = nn.Sequential(*list(resnet.children())[:-3])
